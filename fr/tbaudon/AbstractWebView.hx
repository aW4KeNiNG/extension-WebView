...
class AbstractWebView extends Sprite {
    ...
    /**
        Use this function to prevent a web from load. Url + target parameters
    ...
    **/
    function new(defaultUrl : String, w : Float = 400, h : Float = 400, close : Bool = false, userAgent : String = null) {
        super();
